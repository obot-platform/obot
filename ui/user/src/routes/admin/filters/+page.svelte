			...
			>
				{#if filters.length === 0}
					<div class="mt-12 flex w-md flex-col items-center gap-4 self-center text-center">
						<Filter class="text-base-content/40 size-24 opacity-50" />
						<h4 class="text-base-content/40 text-lg font-semibold">No created filters</h4>
								...
								{:else if property === 'status'}
									<span
										class={d.status === 'Disabled'
											? 'text-base-content/40 font-light italic text-xs'
