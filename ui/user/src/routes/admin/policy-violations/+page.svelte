		...
		<div class="mb-4 flex flex-col gap-4">
			...
			>
				...
				{#if !loading && violations.length === 0}
					...
					>
						<ShieldAlert class="text-base-content/40 size-24 opacity-50" />
						<h4 class="text-base-content/40 text-lg font-semibold">No policy violations</h4>
					...
					>
						<table class="w-full flex-1 table-fixed border-collapse border-spacing-0">
							<thead>
								<tr>
									<th
										class="dark:bg-base-200 bg-base-300 text-base-content/40 sticky top-0 box-content w-[4ch] px-6 py-3 text-left text-xs font-medium tracking-wider uppercase"
									>
										#
									</th>
									<th
										class="dark:bg-base-200 bg-base-300 text-base-content/40 sticky top-0 box-content w-[34ch] px-6 py-3 text-left text-xs font-medium tracking-wider uppercase"
									>
										Timestamp
									</th>
									<th
										class="dark:bg-base-200 bg-base-300 text-base-content/40 sticky top-0 box-content w-[24ch] px-6 py-3 text-left text-xs font-medium tracking-wider uppercase"
									>
										User
									</th>
									<th
				...
				<div class="default-scrollbar-thin relative flex-1 overflow-y-auto pb-4">
					...
					{#if detailedViolation}
						...
						<div class="p-4 pl-5">
							...
							{:else}
								<p class="text-sm font-light text-base-content/40">
