...
type BucketKind = 'minute' | '5min' | '10min' | 'hour' | '2hour' | '4hour' | 'day' | 'week' | 'month';
...
export function getUserLabels(users: Map<string, OrgUser>, userKeys: string[]): Map<string, string> {
