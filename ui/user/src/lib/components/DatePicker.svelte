<script lang="ts">
	...
	function getDayClass(date: Date): string {
		...
		if (isDateDisabled(date, minDate, maxDate)) {
			return twMerge(baseClasses, 'text-base-content/40 cursor-default opacity-50');
		}
...
<div class="date-picker-container">
	...
	>
		<span class="flex grow items-center gap-2 truncate">
			<Calendar class="text-base-content/40 size-4 shrink-0" />
			<span class={twMerge(!value && 'text-base-content/40')}>
