		...
		<div class="rounded-md border border-gray-100 dark:border-gray-700">
			...
			{:else}
				<div class="flex flex-col divide-y divide-gray-100 dark:divide-gray-700">
					{#if template.projectSnapshotRevision}
						<div class="p-3">
							<h4 class="mb-1 text-xs font-medium text-gray-500">Project Snapshot Created</h4>
							<p class="text-sm text-gray-600 dark:text-gray-300">
								{formatDate(template.projectSnapshotRevision)}
							</p>
						</div>
					{/if}
