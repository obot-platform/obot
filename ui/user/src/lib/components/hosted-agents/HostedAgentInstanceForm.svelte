...
<div class="grid gap-5 md:grid-cols-[minmax(0,1fr)_16rem]">
	<div class="flex min-w-0 flex-col gap-4">
		<section class="border-surface3 bg-surface2 rounded-lg border p-4">
			<div class="mb-4">
				...
				<div class="grid gap-4 sm:grid-cols-2">
					...
					{:else}
						{#if agent.allowUserMCPServers}
							<div class="border-surface3 flex flex-col gap-2 rounded-md border p-3">
	...
	<aside class="border-surface3 bg-surface2 h-fit rounded-lg border p-4 md:sticky md:top-0">
		...
		<div class="mt-3 flex items-center gap-3">
			...
			{:else}
				<div
					class="bg-surface3 flex size-9 items-center justify-center rounded text-sm font-semibold"
				>
		...
		<div class="border-surface3 mt-4 grid gap-2 border-t pt-4 text-xs">
