<script lang="ts">
	import { Container, Layers, Server, BookCopy } from 'lucide-svelte';
	...
	<div class="my-4 flex flex-col gap-4">
		{#if profile.current?.groups.includes(Group.POWERUSER_PLUS)}
			...
			>
				...
				/>
				<div>
					<p class="mb-1 text-sm font-semibold">Custom Server</p>
		...
		>
			...
			/>
			<div>
				<p class="mb-1 text-sm font-semibold">Server Template</p>
				<span class="text-on-surface1 block text-xs leading-4">
