...
<div class="relative flex flex-col">
	...
	>
		...
		<span
			class={twMerge(
				'text-base-content/40 mt-2 text-xs leading-4.5 font-light break-all',
		...
		<div class="line-clamp-1 flex w-full gap-1 pt-2">
			{#each categories as category (category)}
				<div
					class="border-base-400 text-base-content/40 truncate rounded-full border px-1.5 py-0.5 text-[10px] font-light"
				>
					{category}
				</div>
			{/each}
