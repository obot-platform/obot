	...
	<div class="bg-base-300 dark:bg-base-200 p-4 shadow-sm">
		...
		<div class="grid grid-cols-3 gap-4">
			...
			<div class="flex flex-col">
				<span class="text-base-content/40 text-xs">Active Deployments</span>
				<span class="text-lg font-semibold">{capacityInfo.activeDeployments}</span>
			</div>

			<!-- CPU -->
			<div class="flex flex-col">
				<span class="text-base-content/40 text-xs">CPU Requested</span>
			...
			<!-- Memory -->
			<div class="flex flex-col">
				<span class="text-base-content/40 text-xs">Memory Requested</span>
				<span class="text-lg font-semibold">
