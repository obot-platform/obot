	...
	<div class="flex flex-1 flex-col gap-4 px-4 pt-4 pb-4">
				...
				<div class="border-base-300 flex flex-1 flex-col gap-2 rounded-md border">
					...
					<div class="relative flex min-h-[180px] flex-1 flex-col lg:min-h-[120px]">
						...
						>
							...
							{:else}
								<div
									class="w-full h-full flex items-center justify-center text-base-content/40 text-lg font-semibold rounded-lg absolute inset-0 p-8"
									transition:fade={{ duration: 100 }}
								>
									{#if isModelsLoading}
										<p>Loading models...</p>
		...
		{:else}
			...
			<div
				...
				out:fade={{ duration: 0 }}
			>
				<div class="text-base-content/40 mb-2 text-lg font-semibold">
