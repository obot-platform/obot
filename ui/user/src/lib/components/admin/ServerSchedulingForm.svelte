<script lang="ts">
	...
	import ServerScheduleSectionTitle from './server-scheduling/ServerScheduleSectionTitle.svelte';
...
<div class="paper">
	<div>
		<ServerScheduleSectionTitle title="Affinity" />
		<p class="text-sm">
...
<div class="paper">
	<div>
		<ServerScheduleSectionTitle title="Tolerations" />
		<p class="text-sm">
...
<div class="paper">
	<div>
		<ServerScheduleSectionTitle title="Resource Limits & Requests" />
		<p class="text-sm">
...
<div class="paper">
	<div>
		<ServerScheduleSectionTitle title="Runtime Class" />
		<p class="text-sm">
			Specify a <a
