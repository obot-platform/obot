...
>
		...
		{#if newServerManifest && diffManifest}
			...
			{#if !responsive.isMobile}
				<div class="grid h-full grid-cols-2">
					<div class="h-full">
						<h3 class="text-base-content/40 mb-2 px-4 text-sm font-semibold">Current Version</h3>
						<div
					...
					<div class="h-full">
						<h3 class="text-base-content/40 mb-2 px-4 text-sm font-semibold">New Version</h3>
						<div
	...
	{:else}
		<div class="flex items-center justify-center py-8">
			<p class="text-base-content/40">Unable to compare manifests. Missing manifest data.</p>
		</div>
	{/if}
</ResponsiveDialog>
