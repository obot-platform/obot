	...
	<div class="mb-2 flex items-center gap-2">
		...
		{#if showRefresh && onRefresh}
			<button
				...
				class="text-base-content/40 hover:bg-base-300 hover:text-base-content rounded-md p-1 disabled:opacity-50"
				disabled={refreshing}
				...
				<div class="dark:bg-base-200 bg-base-100 border-base-400 sticky top-0 z-10 border-b p-4">
					...
					>
						...
						<input
							...
							class="placeholder:text-base-content/40 flex-1 bg-transparent py-3 outline-none"
							type="text"
					...
					{#each messages as message, i (i)}
						...
						>
							<div class="border-base-400 border-r pr-1 text-right">
								<span class="text-base-content/40 select-none">{i + 1}</span>
							</div>
							<span class="text-base-content/40 flex-1">
			...
			{:else}
				<div class="flex w-full flex-1 items-center justify-center p-6">
					<div class="text-center">
						<div class="text-base-content/40 font-medium">No deployment logs.</div>
						<p class="text-base-content/40 mt-1 text-sm">Try refreshing the logs.</p>
					</div>
				</div>
			{/if}
		</div>
