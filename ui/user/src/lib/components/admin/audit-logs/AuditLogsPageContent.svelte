...
<dialog
	...
	class="dark:border-surface1 dark:bg-surface1 fixed! top-0! right-0! bottom-0! left-auto! outline-none! z-40 h-dvh w-auto max-w-none rounded-none border-0 bg-white shadow-lg"
>
	{#if selectedAuditLog}
