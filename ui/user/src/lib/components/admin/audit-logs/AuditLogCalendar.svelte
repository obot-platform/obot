...
<div class="flex w-full md:max-w-fit">
	<button
		type="button"
		class="dark:border-base-400 dark:hover:bg-base-300/70 dark:active:bg-base-300 dark:bg-base-100 hover:bg-base-100/70 active:bg-base-100 bg-base-100 relative z-40 flex min-h-12.5 flex-1 flex-shrink-0 items-center gap-2 truncate rounded-l-lg border border-r-0 border-transparent px-2 text-sm shadow-sm transition-colors duration-200 disabled:opacity-50"
		{disabled}
		use:refAction
		onclick={() => {
			if (!disabled) {
	...
	>
		<span class="bg-base-400 rounded-md px-3 py-1 text-xs">
	...
	<Calendar
		compact
		class="dark:border-base-400 hover:bg-base-100 dark:hover:bg-base-400 dark:bg-base-100 bg-base-100 relative z-40 flex min-h-12.5 shrink-0 items-center gap-2 truncate rounded-none rounded-r-lg border border-transparent px-4 text-sm shadow-sm"
		initialValue={{
