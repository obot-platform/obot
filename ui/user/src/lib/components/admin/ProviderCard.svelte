...
>
	...
	{#if darkMode.isDark}
		...
		<img
			src={url}
			alt={provider.name}
			class={twMerge('size-16 rounded-md p-1', !provider.iconDark && 'bg-base-300')}
		/>
	{:else}
	...
	<div class="mt-auto w-full">
		{#if isComingSoon}
			<div
				class="bg-base-200 dark:bg-base-400 text-base-content/40 flex items-center justify-center gap-1 rounded-xs px-4 py-2 text-sm"
			>
