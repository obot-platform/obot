...
export function computeTintedThemePatch(
	...
	return {
		...
		surface1Color: applyHueTintShadeToSurface(light.surface1Color, L.hueDeg, L.tint0to100, L.shadeTick),
		surface2Color: applyHueTintShadeToSurface(light.surface2Color, L.hueDeg, L.tint0to100, L.shadeTick),
		surface3Color: applyHueTintShadeToSurface(light.surface3Color, L.hueDeg, L.tint0to100, L.shadeTick),
