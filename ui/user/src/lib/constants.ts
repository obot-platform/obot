...
export const UNAUTHORIZED_PATHS = new Set([
	...
	'/login/local',
	// Activation carries its setup capability in the URL fragment. Redirecting an anonymous
	// visitor away from this page would discard the only browser-side copy of that capability.
	'/activate'
]);
