...
- Image: the default value is `ghcr.io/obot-platform/mcp-images/phat:v0.20.2` and it can be changed by setting the Helm value `.config.OBOT_SERVER_MCPBASE_IMAGE`.
