...
| `OBOT_SERVER_MCPREMOTE_SHIM_BASE_IMAGE` | Deploy composite MCP servers using this base image. The setting name is retained for compatibility. | `ghcr.io/obot-platform/nanobot:v0.0.89` |
