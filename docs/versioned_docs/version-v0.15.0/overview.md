...
Open [http://localhost:8080](http://localhost:8080) in your browser to access the Obot UI. You can find your bootstrap token in the container logs (`docker logs obot`). This is used for initial setup.
