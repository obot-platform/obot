...
replace (
	github.com/obot-platform/kinm => github.com/calvinmclean/kinm v0.0.0-20260417173945-6d4c790c9b79
	github.com/obot-platform/nah => github.com/calvinmclean/nah v0.0.0-20260417170953-f4c44603ffe3
