...
func (c *Controller) setupRoutes() {
	...
	systemMCPServerHandler := systemmcpserver.New(c.services.GPTClient, c.services.MCPLoader, c.services.ServerURL, c.services.LocalK8sClient, c.services.ObotNamespace)
