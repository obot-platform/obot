...
func schema_obot_platform_obot_apiclient_types_AppK8sSettings(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AppK8sSettings surfaces Helm-managed Obot server pod scheduling configuration. Values are read-only and sourced from the Obot Deployment pod template at request time.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"affinity": {
						SchemaProps: spec.SchemaProps{
