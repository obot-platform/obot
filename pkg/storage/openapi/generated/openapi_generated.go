...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/obot-platform/obot/pkg/storage/apis/obot.obot.ai/v1.PowerUserWorkspaceResourceCounts": schema_storage_apis_obotobotai_v1_PowerUserWorkspaceResourceCounts(ref),
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"powerUserWorkspaceID": {
						SchemaProps: spec.SchemaProps{
							Description: "PowerUserWorkspaceID contains the ID of the PowerUserWorkspace that owns this server, if there is one.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_storage_apis_obotobotai_v1_PowerUserWorkspaceResourceCounts(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"role": {
						SchemaProps: spec.SchemaProps{
							Description: "Role is the user's role (admin, power-user, power-user-plus)",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
...
func schema_storage_apis_obotobotai_v1_PowerUserWorkspaceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"resourceCounts": {
						SchemaProps: spec.SchemaProps{
							Description: "ResourceCounts tracks the number of resources in this workspace",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/obot-platform/obot/pkg/storage/apis/obot.obot.ai/v1.PowerUserWorkspaceResourceCounts"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/obot-platform/obot/pkg/storage/apis/obot.obot.ai/v1.PowerUserWorkspaceResourceCounts"},
	}
}
