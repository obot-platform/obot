...
ALTER TABLE llm_audit_logs ADD COLUMN IF NOT EXISTS request_path text NOT NULL DEFAULT '';
ALTER TABLE llm_audit_logs ADD COLUMN IF NOT EXISTS request_method text NOT NULL DEFAULT '';
