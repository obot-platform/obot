...
var (
	adminAndOwnerRules = []string{
		...
		"GET /api/group-role-assignments/{groupName}",
		"POST /api/group-role-assignments",
		"PUT /api/group-role-assignments/{groupName}",
		"DELETE /api/group-role-assignments/{groupName}",
