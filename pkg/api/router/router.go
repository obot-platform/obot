...
func Router(ctx context.Context, services *services.Services) (http.Handler, error) {
	...
	mcpGateway := mcpgateway.NewHandler(services.StorageClient, services.GPTClient, services.MCPLoader, services.WebhookHelper, services.OAuthServerConfig.ScopesSupported, services.NanobotIntegration)
