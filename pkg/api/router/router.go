...
func Router(services *services.Services) (http.Handler, error) {
	...
	generatedImages := handlers.NewGeneratedImageHandler(services.GatewayClient, services.GeminiClient)
	...
	// Generated Images
	mux.HandleFunc("POST /api/generated/images", generatedImages.GenerateImage)
	mux.HandleFunc("GET /api/generated/images/{id}", generatedImages.GetGeneratedImage)
