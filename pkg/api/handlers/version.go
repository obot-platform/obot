...
func NewVersionHandler(ctx context.Context, gatewayClient *client.Client, emailDomain, postgresDSN, engine string, supportDocker, authEnabled, disableUpdateCheck, disableChatToolConfirm bool) (*VersionHandler, error) {
...
func (v *VersionHandler) getVersionResponse() map[string]any {
	...
	values["disableChatToolConfirm"] = v.disableChatToolConfirm
	v.upgradeLock.RLock()
