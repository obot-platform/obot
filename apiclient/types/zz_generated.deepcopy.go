...
func (in *MCPServerCatalogEntryManifest) DeepCopyInto(out *MCPServerCatalogEntryManifest) {
	*out = *in
	...
	if in.NanobotConfig != nil {
		in, out := &in.NanobotConfig, &out.NanobotConfig
		*out = new(NanobotRuntimeConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Env != nil {
		in, out := &in.Env, &out.Env
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NanobotRuntimeConfig) DeepCopyInto(out *NanobotRuntimeConfig) {
	*out = *in
	if in.Args != nil {
		in, out := &in.Args, &out.Args
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NanobotRuntimeConfig.
func (in *NanobotRuntimeConfig) DeepCopy() *NanobotRuntimeConfig {
	if in == nil {
		return nil
	}
	out := new(NanobotRuntimeConfig)
