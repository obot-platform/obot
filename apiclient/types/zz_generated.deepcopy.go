...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModelProviderConfigurationParameter) DeepCopyInto(out *ModelProviderConfigurationParameter) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModelProviderConfigurationParameter.
func (in *ModelProviderConfigurationParameter) DeepCopy() *ModelProviderConfigurationParameter {
	if in == nil {
		return nil
	}
	out := new(ModelProviderConfigurationParameter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModelProviderStatus) DeepCopyInto(out *ModelProviderStatus) {
	*out = *in
	...
	if in.RequiredConfigurationParameters != nil {
		in, out := &in.RequiredConfigurationParameters, &out.RequiredConfigurationParameters
		*out = make([]ModelProviderConfigurationParameter, len(*in))
		copy(*out, *in)
	}
	if in.OptionalConfigurationParameters != nil {
		in, out := &in.OptionalConfigurationParameters, &out.OptionalConfigurationParameters
