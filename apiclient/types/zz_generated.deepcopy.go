...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompositeParameterMapping) DeepCopyInto(out *CompositeParameterMapping) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompositeParameterMapping.
func (in *CompositeParameterMapping) DeepCopy() *CompositeParameterMapping {
	if in == nil {
		return nil
	}
	out := new(CompositeParameterMapping)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CompositeRuntimeConfig) DeepCopyInto(out *CompositeRuntimeConfig) {
	*out = *in
	if in.ComponentCatalogEntries != nil {
		in, out := &in.ComponentCatalogEntries, &out.ComponentCatalogEntries
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ToolMappings != nil {
		in, out := &in.ToolMappings, &out.ToolMappings
		*out = make([]CompositeToolMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompositeToolMapping) DeepCopyInto(out *CompositeToolMapping) {
	*out = *in
	if in.ParameterMappings != nil {
		in, out := &in.ParameterMappings, &out.ParameterMappings
		*out = make([]CompositeParameterMapping, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompositeToolMapping.
func (in *CompositeToolMapping) DeepCopy() *CompositeToolMapping {
	if in == nil {
		return nil
	}
	out := new(CompositeToolMapping)
	in.DeepCopyInto(out)
	return out
}
