...
func (in *AccessControlRuleManifest) DeepCopyInto(out *AccessControlRuleManifest) {
	*out = *in
	...
	if in.MCPServerCatalogEntryIDs != nil {
		in, out := &in.MCPServerCatalogEntryIDs, &out.MCPServerCatalogEntryIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.MCPServerIDs != nil {
		in, out := &in.MCPServerIDs, &out.MCPServerIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
