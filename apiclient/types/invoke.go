...
// ToolConfirmRequest is sent when a tool call needs user approval
...
const (
	...
	// ToolConfirmDecisionAllow indicates the tool call has been approved.
...
type ToolConfirmResponse struct {
	...
	// This field may only be set when Decision is ToolConfirmDecisionApproveThread.
	ToolName string `json:"threadApprovedTools,omitempty"`
}
